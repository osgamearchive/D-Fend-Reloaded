object ProfileMountEditorFloppyImage2Frame: TProfileMountEditorFloppyImage2Frame
  Left = 0
  Top = 0
  Width = 697
  Height = 337
  ...
  object FloppyImageButton2: TSpeedButton
    ...
    ShowHint = True
    OnClick = FloppyImageButton2Click
  end
  object FloppyImageCreateButton2: TSpeedButton
    ...
    ParentShowHint = False
    ShowHint = True
    OnClick = FloppyImageCreateButton2Click
  end
  object FloppyImageDelButton: TSpeedButton
    ...
    ParentShowHint = False
    ShowHint = True
    OnClick = FloppyImageDelButtonClick
  end
  object FloppyImageAddButton: TSpeedButton
    ...
    ParentShowHint = False
    ShowHint = True
    OnClick = FloppyImageAddButtonClick
  end
