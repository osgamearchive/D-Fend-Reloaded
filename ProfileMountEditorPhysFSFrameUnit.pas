...
procedure TProfileMountEditorPhysFSFrame.MakeNormalDriveButtonClick(Sender: TObject);
Var P : TPoint;
...
procedure TProfileMountEditorPhysFSFrame.UpdateGameExe(const NewFolder: String);
Var S,T : String;
    I,J : Integer;
begin
