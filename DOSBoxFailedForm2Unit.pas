...
type
  TDOSBoxFailedForm2 = class(TForm)
    OKButton: TBitBtn;
    InfoLabel: TLabel;
...
var
  DOSBoxFailedForm2: TDOSBoxFailedForm2;
...
procedure TDOSBoxFailedForm2.FormShow(Sender: TObject);
Var St : TStringList;
begin
  SetVistaFonts(self);
...
procedure TDOSBoxFailedForm2.LoadSettings;
Var S,T : String;
    I : Integer;
begin
...
procedure TDOSBoxFailedForm2.FormClose(Sender: TObject; var Action: TCloseAction);
begin
...
begin
  ...
  DOSBoxFailedForm2:=TDOSBoxFailedForm2.Create(AOwner);
  try
    DOSBoxFailedForm2.GameDB:=AGameDB;
    DOSBoxFailedForm2.Game:=AGame;
    DOSBoxFailedForm2.ShowModal;
  finally
    DOSBoxFailedForm2.Free;
  end;
end;
