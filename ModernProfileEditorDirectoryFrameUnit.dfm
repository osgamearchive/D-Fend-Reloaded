object ModernProfileEditorDirectoryFrame: TModernProfileEditorDirectoryFrame
  Left = 0
  Top = 0
  Width = 615
  Height = 450
  ...
  object GenerateScreenshotFolderNameButton: TBitBtn
    ...
    TabOrder = 1
    OnClick = GenerateScreenshotFolderNameButtonClick
  end
  object DataFolderEdit: TLabeledEdit
    ...
    EditLabel.Width = 71
    EditLabel.Height = 13
    EditLabel.Caption = 'DataFolderEdit'
    TabOrder = 2
  end
  object GenerateGameDataFolderNameButton: TBitBtn
    ...
    TabOrder = 3
    OnClick = GenerateGameDataFolderNameButtonClick
  end
