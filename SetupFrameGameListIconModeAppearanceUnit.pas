...
procedure TSetupFrameGameListIconModeAppearance.InitGUIAndLoadSetup(InitData: TInitData);
begin
...
procedure TSetupFrameGameListIconModeAppearance.ShowFrame(const AdvencedMode: Boolean);
begin
end;
