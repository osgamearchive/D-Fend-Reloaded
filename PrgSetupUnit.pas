...
Type TPrgSetup=class(TBasePrgSetup)
  ...
  public
    ...
    property FavoritesBold : Boolean index 45 read GetBoolean write SetBoolean;
    property FavoritesItalic : Boolean index 46 read GetBoolean write SetBoolean;
    property FavoritesUnderline : Boolean index 47 read GetBoolean write SetBoolean;
    property ScreenshotListUseFirstScreenshot : Boolean index 48 read GetBoolean write SetBoolean;
    property FullscreenInfo : Boolean index 49 read GetBoolean write SetBoolean;
    property GridLinesInGamesList : Boolean index 50 read GetBoolean write SetBoolean;
    property QuickStarterMaximized : Boolean index 51 read GetBoolean write SetBoolean;
    property QuickStarterDOSBoxFullscreen : Boolean index 52 read GetBoolean write SetBoolean;
    property QuickStarterDOSBoxAutoClose : Boolean index 53 read GetBoolean write SetBoolean;
    property FileTypeFallbackForEditor : Boolean index 54 read GetBoolean write SetBoolean;
    property AutoFixLineWrap : Boolean index 55 read GetBoolean write SetBoolean;
    property CenterScummVMWindow : Boolean index 56 read GetBoolean write SetBoolean;
    property HideScummVMConsole : Boolean index 57 read GetBoolean write SetBoolean;
    property ShowShortNameWarnings : Boolean index 58 read GetBoolean write SetBoolean;
    property RestoreWhenScummVMCloses : Boolean index 59 read GetBoolean write SetBoolean;
    property UseWindowsExeIcons : Boolean index 60 read GetBoolean write SetBoolean;
    property MinimizeOnWindowsGameStart : Boolean index 61 read GetBoolean write SetBoolean;
    property RestoreWhenWindowsGameCloses : Boolean index 62 read GetBoolean write SetBoolean;
    property RestoreFilter : Boolean index 63 read GetBoolean write SetBoolean;
    ...
    property RenameProfFileOnRenamingProfile : Boolean index 66 read GetBoolean write SetBoolean;
    property ScanFolderAllGames : Boolean index 67 read GetBoolean write SetBoolean;
    property ScanFolderUseFileName : Boolean index 68 read GetBoolean write SetBoolean;
    property ShowAddGameInfoOnEmptyGamesList : Boolean index 69 read GetBoolean write SetBoolean;
    property RestorePreviewerCategory : Boolean index 70 read GetBoolean write SetBoolean;
    property ShowMainMenu : Boolean index 71 read GetBoolean write SetBoolean;
    property IgnoreDirectoryCollisions : Boolean index 72 read GetBoolean write SetBoolean;
    property CreateConfFilesForProfiles : Boolean index 73 read GetBoolean write SetBoolean;
    property AddMountingDataAutomatically : Boolean index 74 read GetBoolean write SetBoolean;
    property BinaryCache : Boolean index 75 read GetBoolean write SetBoolean;
    property ImportZipWithoutDialogIfPossible : Boolean index 76 read GetBoolean write SetBoolean;
...
begin
  ...
  AddBooleanRec(45,'ProgramSets','Favorites.Bold',True);
  AddBooleanRec(46,'ProgramSets','Favorites.Italic',False);
  AddBooleanRec(47,'ProgramSets','Favorites.Underline',False);
  AddBooleanRec(48,'ProgramSets','ScreenshotsGamesList.UseFirstScreenshot',True);
  AddBooleanRec(49,'ProgramSets','ShowFullscreenInfo',True);
  AddBooleanRec(50,'ProgramSets','GridLinesInGamesList',False);
  AddBooleanRec(51,'ProgramSets','QuickStarterMaximized',False);
  AddBooleanRec(52,'ProgramSets','QuickStarterDOSBoxFullscreen',False);
  AddBooleanRec(53,'ProgramSets','QuickStarterDOSBoxAutoClose',True);
  AddBooleanRec(54,'ProgramSets','FileTypeFallbackForEditor',True);
  AddBooleanRec(55,'ProgramSets','AutoFixLineWrap',False);
  AddBooleanRec(56,'ProgramSets','CenterScummVMWindow',False);
  AddBooleanRec(57,'ProgramSets','HideScummVMConsole',True);
  AddBooleanRec(58,'ProgramSets','ShowShortNameWarnings',True);
  AddBooleanRec(59,'ProgramSets','RestoreWhenScummVMCloses',False);
  AddBooleanRec(60,'ProgramSets','UseWindowsExeIcons',True);
  AddBooleanRec(61,'ProgramSets','MinimizeOnWindowsGameStart',False);
  AddBooleanRec(62,'ProgramSets','RestoreWhenWindowsGameCloses',False);
  AddBooleanRec(63,'ProgramSets','RestoreFilter',True);
  AddBooleanRec(64,'ProgramSets','AllowPixelShader',False);
  AddBooleanRec(65,'ProgramSets','StoreColWidths',False);
  AddBooleanRec(66,'ProgramSets','RenameProfFileOnRenamingProfile',False);
  AddBooleanRec(67,'ProgramSets','ScanFolderAllGames',False);
  AddBooleanRec(68,'ProgramSets','ScanFolderUseFileName',True);
  AddBooleanRec(69,'ProgramSets','ShowAddGameInfoOnEmptyGamesList',True);
  AddBooleanRec(70,'ProgramSets','RestorePreviewerCategory',True);
  AddBooleanRec(71,'ProgramSets','ShowMainMenu',True);
  AddBooleanRec(72,'ProgramSets','IgnoreDirectoryCollisions',False);
  AddBooleanRec(73,'ProgramSets','CreateConfFilesForProfiles',False);
  AddBooleanRec(74,'ProgramSets','AddMountingDataAutomatically',True);
  AddBooleanRec(75,'ProgramSets','BinaryCache',True);
  AddBooleanRec(76,'ProgramSets','ImportZipWithoutDialogIfPossible',True);
