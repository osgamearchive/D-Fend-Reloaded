...
const ID_Index=1;
      ...
      ID_ProfileEditScummVMGame=2106;
      ID_ProfileEditCPU=2107;
      ID_ProfileEditMemory=2108;
      ID_ProfileEditGraphics=2109;
      ID_ProfileEditKeyboard=2110;
      ID_ProfileEditMouse=2111;
      ID_ProfileEditSound=2112;
      ID_ProfileEditSoundVolume=2113;
      ID_ProfileEditSoundSoundBlaster=2114;
      ID_ProfileEditSoundGUS=2115;
      ID_ProfileEditSoundMIDI=2116;
      ID_ProfileEditJoystick=2117;
      ID_ProfileEditDrives=2118;
      ID_ProfileEditSerialPorts=2119;
      ID_ProfileEditNetwork=2120;
