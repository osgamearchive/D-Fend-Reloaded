...
type
  ...
  protected
    ...
    procedure HE_memset(var output: array of LONGLONG; const value: LONGLONG; const start, len: cardinal); overload;
  end;
...
// Note: Replace "for loop" with standard memset if possible.
procedure THashAlgEngine.HE_memset(var output: array of LONGLONG; const value: LONGLONG; const start, len: cardinal);
var
  i: cardinal;
begin
  for i:=1 to len do
