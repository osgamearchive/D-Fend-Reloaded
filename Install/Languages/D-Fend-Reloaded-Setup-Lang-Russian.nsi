...
LangString LANGNAME_WelcomeText ${LANG_RUSSIAN} "Этот мастер поможет вам выполнить установку ${PrgName}.\r\n\r\nD-Fend Reloaded - программа с открытыми исходными текстами, распространяется по лицензии GPL 3. (Вы можете ознакомиться с лицензионным соглашением, выбрав в программе пункт меню 'Справка|О программе...'.)\r\n\r\nНажмите кнопку 'Далее' для продолжения."
