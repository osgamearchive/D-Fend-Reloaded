...
!macro BetaWarning
;MessageBox MB_OK "This is not D-Fend Reloaded 0.9.2 ! This is the release candiate 2 of version 0.9.2 ! This means this version is very close to the final release 0.9.2 but there might be some unfixed bugs etc. Please do not use this version unless you want to do beta testing. The final release will be released very soon."
