...
xcopy "%USERPROFILE%\Desktop\D-Fend Reloaded" "..\Tools\PortableApps package\D-Fend Reloaded Portable\App" /E

"C:\Program Files\NSIS\makensis.exe" "..\Tools\PortableApps package\D-Fend Reloaded Portable\Other\Launcher Source\PortableAppsLauncher.nsi"
"C:\Program Files\NSIS\makensis.exe" "..\Tools\PortableApps package\D-Fend Reloaded Portable\Other\Installer Source\PortableApps.comInstaller.nsi"
...
md "..\Tools\PortableApps package\D-Fend Reloaded Portable\TempAppInfo"
xcopy "..\Tools\PortableApps package\D-Fend Reloaded Portable\App\AppInfo\*.*" "..\Tools\PortableApps package\D-Fend Reloaded Portable\TempAppInfo\*.*"

del "..\Tools\PortableApps package\D-Fend Reloaded Portable\App\*.*" /S /Q
rd "..\Tools\PortableApps package\D-Fend Reloaded Portable\App" /S /Q

md "..\Tools\PortableApps package\D-Fend Reloaded Portable\App"
md "..\Tools\PortableApps package\D-Fend Reloaded Portable\App\AppInfo"
xcopy "..\Tools\PortableApps package\D-Fend Reloaded Portable\TempAppInfo\*.*" "..\Tools\PortableApps package\D-Fend Reloaded Portable\App\AppInfo\*.*"

del "..\Tools\PortableApps package\D-Fend Reloaded Portable\TempAppInfo\*.*" /Q
rd "..\Tools\PortableApps package\D-Fend Reloaded Portable\TempAppInfo"
